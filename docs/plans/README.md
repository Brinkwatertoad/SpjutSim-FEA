...
15. [ ] [Deliver convergence, validation, and the v1.0 release gate](15-convergence-validation-and-v1-release.md) — workflow, independent references, and CAD corpus complete; browser-resource and redistribution gates remain open (see `../release/v1-acceptance-audit.md`)
