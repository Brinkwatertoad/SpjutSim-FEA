...
- [ ] **Calibrate memory and solver behavior (carried forward to
  [Task 18](18-browser-resource-calibration.md)).** Make the estimator account for
...
- [ ] **Choose the measured PCG configuration (carried forward to
  [Task 18](18-browser-resource-calibration.md)).** Run representative Tet10
