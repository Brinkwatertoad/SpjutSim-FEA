...
- [ ] **Define the corpus manifest.** Add `tests/fixtures/corpus-v1.json` with
...
- [ ] **Build the fixed release set.** Grow the corpus to at least 50 entries:
...
- [ ] **Record fixture generation and provenance.** Add reproducible generation
  ...
  terms are ambiguous.
- [ ] **Add the batch browser runner.** Create
...
- [ ] **Enforce useful diagnostics.** Require every invalid/troublesome case to
...
- [ ] **Set the v1 import gate.** Require 100% agreement with the manifest:
...
- [ ] **Calibrate the quality warning from the corpus.** Compare gamma minimum,
...
- [ ] **Document and audit.** Add the runner and corpus commands to `README.md`,
